        	...
        	<form name="frmAdd" method="post" action="{!! route('admin.product.postAdd') !!}" enctype="multipart/form-data">
	                  		...
	                  		<div class="row">
		                  		<div class="col-md-6 col-xs-12">
									...
									<div class="form-group">
								      	...
								      	<input type="text" name="nhacc"  value=""  class="form-control" />
									</div>
									<div class="form-group">
								      	<label for="ten">Trọng lượng</label>
								      	<input type="text" name="trongluong"  value=""  class="form-control" />
									</div>
									<div class="form-group">
								      	<label for="ten">Bảo hành</label>
								      	<input type="text" name="baohanh"  value=""  class="form-control" />
									</div>
			    ...
			    <div class="col-md-6">
				    ...
				    <div class="form-group">
				   	...
				   	<!-- <div class="form-group">
					    <label>
				        	<input type="checkbox" name="spbc"> Xe cũ
				    	</label>
				    </div>	 -->
			    	<!-- <div class="form-group">
					    <label>

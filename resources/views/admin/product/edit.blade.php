        		...
        		<input type="hidden" name="_token" value="{!! csrf_token() !!}" />
      			...
      			<div class="nav-tabs-custom">
	                <ul class="nav nav-tabs">
	                  	...
	                  	<li><a href="#tab_2" data-toggle="tab" aria-expanded="true">Thông số kĩ thuật</a></li>
	                  		...
	                  		<div class="row">
		                  		<div class="col-md-6 col-xs-12">
									...
									<div class="form-group">
								      	...
								      	<input type="text" name="nhacc"  value="{{$data->nhacc}}"  class="form-control" />
									</div>
									
									<div class="form-group">
								      	<label for="ten">Trọng lượng</label>
								      	<input type="text" name="trongluong"  value="{{$data->trongluong}}"  class="form-control" />
									</div>
									<div class="form-group">
								      	<label for="ten">Bảo hành</label>
								      	<input type="text" name="baohanh"  value="{{$data->baohanh}}"  class="form-control" />
									</div>

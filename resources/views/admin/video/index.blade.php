          ...
          <table id="example2" class="table table-bordered table-hover">
            <thead>
              <tr>
                ...
                <th class="text-center with_dieuhuong">Hình ảnh</th>
                <th class="text-center with_dieuhuong">Tên</th>
                <th class="text-center with_dieuhuong">Mô tả</th>
                <th class="text-center with_dieuhuong">Link</th>
                <!-- <th>Link</th> -->

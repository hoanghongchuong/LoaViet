...
<div class="container">
    <ul class="bread">
      ...
      <li class="active"><a href="{{url('gioi-thieu')}}" title="">Giới thiệu</a></li>
    </ul>
    <div class="page-img">
      <div class="row">
        <div class="col-lg-9 offset-lg-3 col-md-12">
          ...
          <a class="f-mont page-img-tit" href="{{url('gioi-thieu')}}" title="">Giới thiệu</a>
        </div>
      </div>
    </div>
  </div>
      ...
      <div class="row">
        ...
        <div class="col-lg-9">
          <div class="pro-wrap about-wrap">
            ...
            <!-- <div class="about-cm">
              <img src="images/cm.png" title="" alt="">
            </div> -->
          </div>
        </div>
      </div>

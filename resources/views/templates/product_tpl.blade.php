...
<div class="container">
    <ul class="bread">
        ...
        <li class="active"><a href="{{url('san-pham')}}" title="">Sản phẩm</a></li>
    </ul>
    <div class="page-img">
        <div class="row">
            <div class="col-lg-9 offset-lg-3 col-md-12">
                <div class="d-flex align-items-center justify-content-between flex-md-row flex-column page-img-wrap">
                    <div class="">
                        ...
                        <a class="f-mont page-img-tit" href="#" title="">Tất cả sản phẩm</a>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-6 mb50">
                            <div class="pro-item">
                                ...
                                @else
                                <a class="tblue" href="#" title="{{$item->name}}">Liên hệ</a>
                                @endif
                                <a href="#" class="btn w-100 text-uppercase add-btn" title="">Thêm vào giỏ hàng</a>
                            </div>
                        </div>
                        @endforeach
                    </div>

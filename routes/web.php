...
Route::get('tra-gop', 'IndexController@traGop');

Route::get('huong-dan-dat-hang','IndexController@huongDanDatHang');
Route::get('video','IndexController@getVideo');
Route::get('video/{alias}','IndexController@getDetailVideo');

Route::get('destroy-cart', 'IndexController@destroyCart');
// Route::post('rating','IndexController@rating')->name('rating');
Route::get('updatedblaravel',['as'=>'updatedblaravel', 'uses'=>'IndexController@updatedblaravel']);
Route::get('updateCateChild',['as'=>'updatedblaravel', 'uses'=>'IndexController@updateCateChild']);
Route::get('updateproudct',['as'=>'updateproudct', 'uses'=>'IndexController@updateproudct']);
Route::get('updatecatenews',['as'=>'updatecatenews', 'uses'=>'IndexController@updatecatenews']);
Route::get('updatenews',['as'=>'updatenews', 'uses'=>'IndexController@updatenews']);
